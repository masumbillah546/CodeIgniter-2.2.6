...
$config['base_url'] = 'http://localhost/CodeIgniter-2.2.6/users/view_users';
...
public function new_user() {
	 ...
	 $data['is_active'] = array(  'name' =>'is_active',
								  'id' => 'is_active',
 ...
 public function edit_user() {
	 ...
	 $data['is_active'] = array( 'name' => 'is_active',
								 'id' => 'is_active',
								 'value' => set_value('is_active', $is_active),
								 'maxlength' => '100',
								  'class' => 'form-control'
								);
...
} // users extends CI_Controller class end
