...
class Register extends CI_Controller {
 ...
 // Set validation rules
		...
		$this->form_validation->set_rules('email', 'Email',
			...
			valid_email|is_unique[register.user_email]');
 ...
 // Create hash from user password
		...
		$banch=$this->benchmark->elapsed_time('code_start', 'code_end');

		echo "<span style='background-color:green; color:white; padding:5px'>".$banch."</span>";
	}
